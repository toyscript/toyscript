...
# for k, v in place_frequencies:
#     print(k, ":", v)
# print()

# for k, v in place_scenes:
#     print(k, ":", v)
# print()

for k, v in place_characters:
    print(k, ":", v)
print()

print(len(places))
print(len(place_frequencies))
print(len(place_scenes))
print(len(place_characters))
