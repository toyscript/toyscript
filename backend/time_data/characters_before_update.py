...
character_frequencies = count_frequency_of_characters(all_capital_lines)

characters = get_character_list(character_frequencies)
# print('OLEG' in characters)
# print(characters)
# print('\n'.join(characters))
...
for k, v in sorted(character_frequencies, key=lambda x: x[1], reverse=True):
    print(k, ":", v)

# print(num_of_blank_lines)
